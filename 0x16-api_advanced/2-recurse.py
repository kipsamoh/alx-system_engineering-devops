#!/usr/bin/python3
"""_Module that consumes the Reddit API and _returns a list containing the
titles of all hot articles for a given subreddit."""
import requests


def recurse(subreddit, hot_list=[], n=0, after=None):
    """ _queries the Reddit API and returns a list containing the titles of
